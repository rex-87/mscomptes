...
plt.plot_date(dateconv(df['Timestamp'][:-15]), df['Savings n=30'][15:], 'r-')
plt.plot_date(dateconv(df['Timestamp'][:-45]), df['Savings n=90'][45:], 'g-')
plt.plot_date(dateconv(df['Timestamp'][:-180]), df['Savings n=360'][180:], 'y-')
